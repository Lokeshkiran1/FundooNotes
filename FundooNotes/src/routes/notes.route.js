...
import * as redisCheck from '../middlewares/redis.middleware';
...
router.get('/allNotes',userAuth,redisCheck.allNotesDetails,notesController.getAllNotes);

//router to get a particular note by id
router.get('/:_id',userAuth,redisCheck.getSingleNoteByID,notesController.getNote);
